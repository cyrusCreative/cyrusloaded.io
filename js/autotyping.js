...
const exampleText = ["FrontEnd", "Web Dev.", "Mobile Dev", "Flutter"];
...
const smallText = ["FrontEnd", "Web Dev.", "Mobile Dev", "Flutter"];
const smallTyping = new AutoTyping("#john", smallText, {
  typeSpeed: 50,
  deleteSpeed: 50,
  waitBeforeDelete: 2000,
  waitBetweenWords: 500,
